...
import { deleteSubjet } from "../../../api/subject";
...
function Subjects(props) {
    ...
    const EditSubject = (subject) => {
        setIsVisibleModal(true);
        setModalTitle(
            `Editar ${subject.department ? subject.department : "..."} ${subject.activity_code ? subject.activity_code : "..."
            }`
        );
        setModalContent(
            <EditSubjectForm
...
function Subject(props) {
    ...
    const showDeleteConfirm = () => {
        ...
        confirm({
            ...
            cancelText: "Cancelar",
            onOk() {
                deleteSubjet(accesToken, subject._id)
                    .then((response) => {
